    ...
    <Section className="section__media">
      <Container>
        <div className="relative w-full">
          <div className="media__left w-1/2" data-scroll data-scroll-speed="0.3">
            <div
              className="img w-100 img-cover scale-ratio"
              style={{
                backgroundImage: `url(${"img/examples/ft-1.jpg"})`,
              }}
            />
          </div>
          <div className="media__text relative w-full grid grid-cols-12" data-scroll data-scroll-speed="0.1">
          ...
          <div className="media__right absolute left-0 top-0 w-full grid grid-cols-12"  data-scroll data-scroll-speed="0.8">
